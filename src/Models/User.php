...
use ForeverEson\Permission\Contracts\User as UserContract;
use ForeverEson\Permission\Traits\User as UserTrait;
...
class User extends Model implements UserContract
{
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->name = config('permission.table_names.user');
    }
